(function(wnd) {
    ...
    contentLoaded(wnd, function() {
        ...
        try {
            ...
            img.src = "https://click.appcast.io/peoplefluent-9k/a17.png?r=" + encodeURIComponent(document.referrer) + (reqNum ? "&jid=" +
                reqNum : "") + "&tn=" + now + "&rn=" + random + "&fp=" + fp + '&e=1242';
    ...
    function getReqNum() {
        ...
        for (var i = 0; i < spans.length; i++)
            if (spans[i].className == "pagesubheading")
                if (match = spans[i].innerHTML.trim().match(/(\d+)$/)) return match[1];
        return null
    }
