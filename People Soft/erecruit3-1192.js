(function(wnd) {
    ...
    contentLoaded(wnd, function() {
        ...
        try {
            ...
            var url = "https://click.appcast.io/erecruit-9k/a17.png?r=" +
                encodeURIComponent(document.referrer) + (reqNum ? "&jid=" + reqNum : "") + "&tn=" + now + "&rn=" + random + "&fp=" + fp + '&e=1192';
    ...
    function getReqNum() {
        var element = document.getElementById("HRS_APP_RCMNT_I_HRS_JOB_OPENING_ID$0"),
            jobId = element && (element.innerText || element.textContent).trim();
        return jobId
    }
    ...
    function generateUserToken() {
        return (new Date).getTime() +
            (Math.random() * Math.random()).toString(36).substr(2, 9)
    }
