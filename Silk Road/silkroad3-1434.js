(function(wnd) {
    ...
    contentLoaded(wnd, function() {
        ...
        try {
            ...
            var url = "https://click.app-cast.com/silkroad-9k/a17.png?r=" +
                encodeURIComponent(document.referrer) + (reqNum ? "&jid=" + reqNum : "") + "&tn=" + now + "&rn=" + random + "&fp=" + fp + '&e=1434';
    ...
    function getReqNum() {
        var url = location.href,
            match = null,
            reqNum = null;
        if (url && (match = url.match(/jobid=(\w+)/))) reqNum = match[1];
        else if (sessionStorage && sessionStorage.getItem("jobId")) reqNum = sessionStorage.getItem("jobId");
        return reqNum
    }
