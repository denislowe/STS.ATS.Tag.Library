(function(wnd) {
    ...
    contentLoaded(wnd, function() {
        try {
            ...
            window.acEmployerId = '&e=2676'
        } catch (e) {}
        try {
            saveReqNumToSessionStorage(reqNum);
            var img = document.createElement("img"),
                action = "smashfly-9k/a17";;
            ...
            else if (/9k\/a17/i.test(action)) window.acAction =
                2;
            writeGtm()
        } catch (e$0) {}
    });
    ...
    function writeGtm() {
        try {
            ...
            script.text = "(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-TRPTD9');";
